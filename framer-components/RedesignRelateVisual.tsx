  ...
  <div class="cs-grid">
    ...
    <aside class="cs-sticky">
      ...
      <div class="cs-meta-strip reveal">
        <div class="cs-meta-row"><span class="label">Role</span><span class="value">Visual Designer</span></div>
        <div class="cs-meta-row"><span class="label">Timeline</span><span class="value">Jan–Apr 2023</span></div>
        <div class="cs-meta-row"><span class="label">Tools</span><span class="value">Figma · Material 3</span></div>
      ...
      <div class="cs-impact-callout reveal" style="margin-top:12px; border-color:rgba(94,122,106,0.3); background:rgba(94,122,106,0.08); color:#5e7a6a;">
        ...
        Visual system adopted across the full Relate app surface; enabled market expansion into Ghana.
      </div>
    </aside>
    ...
    <div class="cs-sections">
      ...
      <div class="cs-section">
        ...
        <ul class="cs-list">
          ...
          <li>Create customized components for accessibility needs</li>
        </ul>
      ...
      <div class="cs-section">
        ...
        <ul class="cs-list">
          <li>Use testing and surveys to refine based on feedback</li>
          <li>Keep collaborating on marketing strategies</li>
        </ul>
        <div class="cs-section-body" style="margin-top:24px;"><strong>Lessons learned</strong></div>
        <ul class="cs-list">
          <li>Prioritize product audits to strengthen brand alignment</li>
          <li>Integrate established design-system guidelines early</li>
          <li>Build inclusive practices in for underrepresented user groups</li>
        </ul>
      </div>
...
<a href="/live-transcribe" class="cs-next">
  <div>
    <div class="cs-next-label">Next case study · 03</div>
    <div class="cs-next-title">Live Transcribe<br>Dual Screen</div>
  </div>
...
/**
 * RedesignRelateVisual — local portfolio redesign ported into Framer.
 * Includes custom cursor, typewriter, scroll reveal, and full page styles.
 */
export default function RedesignRelateVisual(props) {
...
RedesignRelateVisual.displayName = "RedesignRelateVisual"

addPropertyControls(RedesignRelateVisual, {
    note: {
        type: ControlType.String,
        title: "Page",
        defaultValue: "Relate Visual",
